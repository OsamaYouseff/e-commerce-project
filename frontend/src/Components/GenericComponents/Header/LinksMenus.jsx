...
const MegaMenuData = [
...

    {
        ...
        subMenu: (<SubMenu listClassName={"BaseLink1-List"}
...
const UserMenuData = [
    ...
    { titleName: "Address" },
    {
        ...
        subMenu: (<SubMenu listClassName={"BaseLink4-List"}
    ...
    },
    {
        ...
        subMenu: (<SubMenu listClassName={"BaseLink5-List"}
...
const ListItemButtonStyles = {
    px: 2, fontSize: "15px", m: 0, borderRadius: "6px",
}
...
function BaseMenu({ titleName, subMenu }) {
    ...
    return (
        <Box className="flex-center" sx={{
            ".css-10hburv-MuiTypography-root": { fontSize: "clamp(10px,calc(12px + (16 - 12) * (100vw - 1000px) / (1920 - 1000)),16px) !important" }
        }} >
            <ListItem cursor="pointer" className="flex-center" sx={{
                maxWidth: "250px",
                position: "relative",
                "&:hover": {
                    ".Base-List": { display: "block", zIndex: "99", bgcolor: theme.palette.categoryColor.main }
                },
                padding: "6px"
            }} >
                <ListItemButton className="flex-center" sx={{
                    px: 1.5, py: 0.31, justifyContent: "center",
                            ...
                            return (
                                <ListItem key={item.id}
                                    ...
                                    <ListItemButton sx={ListItemButtonStyles}>
                                        ...
                                        {item.subMenu != null ? <KeyboardArrowRightIcon fontSize="16px" /> : null}
                                        {item.subMenu}
                                    </ListItemButton>
                                </ListItem>
                            )
                        ...
                        .map((item, index) => {
                            return (
                                <ListItem key={index} sx={{
                                    padding: "0", color: theme.palette.text.primary
                                }}>
                                    <ListItemButton sx={ListItemButtonStyles}>
                                        <ListItemText primary={item.titleName} />
                                    </ListItemButton>
