...
const editCustomerAccount = async () => {
    const customerId = 1;
...
const TestComponent = () => {
    return (
        <div className="App">
            ...
            <Button variant="contained" onClick={createCustomerAccount}>Create Customer</Button>
            <span> | </span>
            <Button variant="contained" color="secondary" onClick={editCustomerAccount}>Edit Customer</Button>
            <span> | </span>
            <Button variant="contained" color="error" onClick={deleteCustomerAccount}>Delete Customer</Button>
        </div>
    );
}
